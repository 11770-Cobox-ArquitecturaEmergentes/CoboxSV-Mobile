...
class AppTypography {
  ...
  static TextTheme get textTheme => const TextTheme(
    displayLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, letterSpacing: -0.5, height: 1.2),
    displayMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, letterSpacing: -0.5, height: 1.2),
    displaySmall: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, letterSpacing: -0.25, height: 1.3),
  ...
  static TextStyle get statisticValue => const TextStyle(fontSize: 28, fontWeight: FontWeight.w700, height: 1.2);
  static TextStyle get cardTitle => const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, height: 1.4);
  static TextStyle get badgeText => const TextStyle(fontSize: 10, fontWeight: FontWeight.w600, height: 1.4);
}
